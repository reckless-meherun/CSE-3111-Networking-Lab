...
def send_msg():
    ...
    message = funcs.encode_message('A',message_serial,adj)
    message_serial+=1
...
def main():
    ...
    while True:
        ...
        flood_receive_thread = threading.Thread(target=funcs.handle_client,args=(client_sock,addr,adj,messages_received,'A',neighbors))
