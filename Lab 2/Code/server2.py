...
def create_socket():
    try:
        ...
        global port
        global sock
        host = '172.29.96.128' #empty because we are goting to put this server.py file into our server and the IP address of the host is gonna be itself
        port = 9005
...
def create_tranxID():
    ...
    print("Transaction ID: ", random_uuid + '\n')
    return random_uuid
